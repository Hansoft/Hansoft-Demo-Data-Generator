# -*- coding: utf-8 -*-
""" Generate lorem ipsum style user, user group and project names."""
import random
...
class LoremGenerator():
	def __init__(self):
		...
		self.surnames = "williams brown jones garcia miller davis rodriguez martinez hernandez lopex gonzalez wilson anderson thomas taylor moore jackson martin lee perez thompson white harris sanchez clark ramirez lewis robinson walker young allen king wright scott torres nguyenhill flores green adams nelson baker hall rivera camobell mitchell carter roberts gomez philips evans turner diaz parker cruz edwards collins reyes stewart morris morales cook rogers gutierrez ortiz morgan coiper peterson bailey reed kelly howard ramos kim cox ward richardson watson brooks chavez wood james bennet gray mendoza ruiz hughes price alvarez castillo sanders patel myerslong ross foster jimenes".split(" ")
	...
	def generateGroupName(self):
		prefix = random.choice(["Site", "Team", "Group", "Test"])
		if prefix == "Site":
